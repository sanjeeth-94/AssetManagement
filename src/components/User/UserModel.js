      ...
      <form onSubmit={onSubmit}>
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            <div style={{display:'flex',marginleft:'20px',marginBottom:'10px', marginTop:'20px'}}>
              <label style={{marginLeft:'40px'}}>Employee ID :</label>
              <TextField id="employeeId" label="Employee ID" variant="outlined"
              onChange={(e) =>{setemployeeId(e.target.value)}}
              value={employeeId}/>
              {/* </div>
              <div style={{display:'flex',marginlef:'20px',marginBottom:'10px'}}> */}
              <label style={{marginLeft:'5px'}}>Employee Name :</label>
            ...
            {/* </div>
            <div style={{display:'flex',marginlef:'20px',marginBottom:'10px'}}> */}
              <label style={{marginLeft:'40px'}}>Designation :</label>
            ...
            {/* </div>
            <div style={{display:'flex',marginlef:'20px',marginBottom:'10px'}}> */}
              <label style={{marginLeft:'40px'}}>Email ID :</label>
