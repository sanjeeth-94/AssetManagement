...
import { ViewTransfer } from '../../services/ApiServices';
...
const Transfer = () => {
  ...
  const [loading , setLoading]=useState(true);
    ...
    useEffect(()=>{
           ViewTransfer(handleViewTransferResult,handleViewTransferError)
         },[]);
      
         const handleViewTransferResult=(dataObject)=>{
         setRows(dataObject.data);
           setLoading(false);
           console.log(dataObject.data);
         }
      
         const handleViewTransferError=(errorStaus, errorMessage)=>{
